...
const dropdowns = {
  ...
  insurance_provider: [
    ...
    'Union Assurance',
    "People's Insurance PLC", 'Continental General', 'Continental - Life',
    'Amana Takaful General', 'Amana Takaful - Life', 'Sri Lanka Insurance - Life',
    'Sanasa - General', 'Co-Operative Insurance - General', 'Co-Operative Insurance - Life',
    'HNB Life',
    'Other',
  ],
